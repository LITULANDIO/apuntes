    ...
    return {
        ...
        execute: function() {
            ...
            CrearPeliculaComponent = (function () {
                ...
                CrearPeliculaComponent.prototype.onCrearPelicula = function (titulo, director, actor, anio) {
                    var pelicula = new pelicula_1.Pelicula(77, titulo, director, actor, anio);
